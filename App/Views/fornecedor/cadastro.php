...
<div class="container">
  ...
  <form action="http://<?php echo APP_HOST; ?>/fornecedor/salvar" method="post" class="row g-3">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
      <label for="inputEmail" class="form-label">E-mail Pessoal</label>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <input type="tel" class="form-control inputTelefone" id="inputTelefone" name="telefone" required>
        </div>
      ...
      <h5 class="text-center">Dados da Empresa</h5>
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="cnpj" id="inputCnpj" class="form-control">
        </div>

      <div class="col-md-5">
      <label for="inputNome_fantasia" class="form-label">Nome Fantasia</label>
        <input type="text" class="form-control" id="inputNome_fantasia" name="nome_fantasia" required>
      </div>
      
      <div class="col-md-4">
      <label for="inputEmail_empresa" class="form-label">E-mail Empresarial</label>
        <input type="email_empresa" class="form-control" id="inputEmail_empresa" name="email_empresa" required>
      </div>
    </div>
