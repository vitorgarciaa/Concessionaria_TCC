...
<body style="margin-bottom: 150px;">
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Concessionária VG</h1>
            <p class="lead">O Seu Destino para Veículos de Qualidade</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Nossa equipe é o coração da Concessionária VG. Com uma equipe de profissionais experientes e apaixonados pelo setor automobilístico, estamos prontos para ajudá-lo a encontrar o veículo perfeito que atenda às suas necessidades e orçamento. Nossa abordagem centrada no cliente significa que você receberá um atendimento personalizado e conselhos especializados durante toda a sua jornada de compra.</p>
            </div>
        </div>
