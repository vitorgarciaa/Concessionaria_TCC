...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-brightness-high"></i> <?php echo $marca->getNome() . ' - ' . $modelo->getNome(); ?></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-calendar"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-palette"></i></h1>
        ...
        ?>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card info-card">
                    <div class="card-body">
                        <h1 class="card-title"><i class="bi bi-car-front"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-joystick"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-check"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-list"></i></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-sliders"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-stop"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-shift"></i></h1>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card info-card">
                <div class="card-body">
                    <h1 class="card-title"><i class="bi bi-cash"></i></h1>
